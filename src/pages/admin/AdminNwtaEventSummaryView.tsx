...
import type { NwtaEventWithRelations } from "@/src/types/nwta-event"
import { formatCurrency, formatEventDateRange, formatVenueLocation } from "./AdminNwtaEventHelperMethods"
import type { Person } from "@/src/types/person"

interface AdminNwtaEventSummaryViewProps {
  event: NwtaEventWithRelations
  paymentStats: Record<string, any>
  toggleExpanded: (id: string) => null | string
  people: Person[]
  isExpanded: boolean
  startEditing: (event: NwtaEventWithRelations) => void
}

export default function AdminNwtaEventSummaryView({
  event,
  paymentStats,
  toggleExpanded,
  people,
  isExpanded,
  startEditing,
}: AdminNwtaEventSummaryViewProps) {
  return (
